...
from app.utils.anime_terbaru_validator import validate_anime_terbaru_item, validate_anime_terbaru_data

class TestAnimeTerbaruValidator(unittest.TestCase):
    @patch('app.utils.anime_terbaru_validator.validate_title')
    @patch('app.utils.anime_terbaru_validator.validate_url')
    @patch('app.utils.anime_terbaru_validator.validate_slug')
    @patch('app.utils.anime_terbaru_validator.validate_image_url')
    def test_validate_anime_terbaru_item(self, mock_validate_image_url, mock_validate_slug, mock_validate_url, mock_validate_title):
        # Setup mocks
        ...
        self.assertEqual(validated_item["episode"], "N/A")
        self.assertEqual(validated_item["rilis"], "N/A")
        self.assertEqual(validated_item["uploader"], "N/A")
    ...
    @patch('app.utils.anime_terbaru_validator.check_url_cover_validity')
    @patch('app.utils.anime_terbaru_validator.validate_anime_terbaru_item')
    def test_validate_anime_terbaru_data(self, mock_validate_anime_terbaru_item, mock_check_url_cover_validity):
        # Setup mocks
        mock_check_url_cover_validity.return_value = True
        mock_validate_anime_terbaru_item.return_value = (True, {
            "judul": "Example Title",
            "url": "https://example.com",
            "anime_slug": "example-slug",
            "cover": "https://example.com/image.jpg",
        ...
        result = validate_anime_terbaru_data(data)
        ...
        mock_validate_anime_terbaru_item.return_value = (False, {})
